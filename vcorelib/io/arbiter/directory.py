...
class DataArbiterDirectories(DataArbiterBase):
    ...
    async def encode_directory_async(
        self,
        pathlike: _Pathlike,
        data: _JsonObject,
        ...
        **kwargs,
        ...
        """Encode a directory using asyncio."""
        ...
        for key, item in data.items():
            result = await self.encode_async(
    ...
    async def decode_directory_async(
        self,
        pathlike: _Pathlike,
        logger: LoggerType = None,
        require_success: bool = False,
        ...
        **kwargs,
        ...
        for child in filter(
            ...
            if child.is_file():
                ...
                load = await self.decode_directory_async(
                    child,
                    logger=logger,
                    require_success=require_success,
                    path_filter=path_filter,
